"""
Copyright 2020 The Allen Institute for Artificial Intelligence
...
Changes:
    Added `[` and `]` as abbreviation delimiters.
    Added no brackets case in searching for abbreviations.
    Added abbreviation detection algorithm for matching words first letter only.
    Pipelined Schwartz&Hearst algorithm to the new one.
